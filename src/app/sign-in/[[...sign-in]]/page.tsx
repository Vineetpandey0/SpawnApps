...
export default async function SignInPage(props: { searchParams: Promise<{ prompt?: string }> }) {
  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center relative overflow-hidden bg-[#fafafa]">
      ...
      <div className="absolute bottom-[-10%] right-[-10%] w-[40%] h-[40%] rounded-full bg-pink-500/15 blur-[120px] pointer-events-none" />
